...
import com.graduation.android.base.constant.ErrorConstant;
import com.graduation.android.base.diff.BaseViewCallback;
import com.graduation.android.base.diff.IModuleBaseDiff;
import com.graduation.android.base.utils.NetworkUtils;
...
import com.graduation.android.base.widget.state.loadsir.callback.EmptyDefaultCallBack;
import com.graduation.android.base.widget.state.loadsir.callback.LoadingCallback;
...
//        mStateView.showCallback(ErrorCallback.class);
    ...
    public void showEmptyViewDefault(CommonState mStateView, final String text, final boolean isShowTopCurve) {
        ...
        mStateView.setupCallback(new EmptyDefaultCallBack(), new Transport() {
            ...
            public void order(Context context, View view) {
                if (isShowTopCurve) {
                    view.findViewById(R.id.common_iv_empty_default_top_curve).setVisibility(View.VISIBLE);
                }
                if (text != null) {
                    ((TextView) view.findViewById(R.id.common_tv_empty_describe)).setText(text);
                }
            }
        });
    ...
    public void showLoadingView(CommonState mStateView) {
        ...
        mStateView.setupCallback(new LoadingCallback(), new Transport() {
            @Override
            public void order(Context context, View view) {
                view.findViewById(R.id.common_tv_tips).setVisibility(View.GONE);
            }
        });
