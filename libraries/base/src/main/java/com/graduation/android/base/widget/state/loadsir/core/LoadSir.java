package com.graduation.android.base.widget.state.loadsir.core;


import com.graduation.android.base.widget.state.loadsir.LoadSirUtil;
...
public class LoadSir {
    ...
    /**
     * Builder模式设计，其中记录了Callback列表与defaultCallback
     */
